...
const SkillCube = ({
  ...
  return (
    <div
      className="text-center text-5xl text-white mx-3 my-2 relative px-4 py-2"
      style={container}
    >
...
const Competencies = () => {
  return (
    <div className="w-1/2 py-24">
      <div className="h-1/2 px-24">
        <div
          className="border-b border-orange-800 pb-12 px-12"
          style={{ color: '#1E2533' }}
        >
          <h1 className="text-5xl">Languages</h1>
          <div className="flex-row pt-12 text-2xl text-center">
            <text>French</text>
            <text> - </text>
            <text>English</text>
          </div>
      ...
      <div className="h-1/2 py-4 px-32">
        <h1 style={{ color: '#1E2533' }} className="text-5xl py-12">
          Skills
        </h1>
